...
const Hero = () => {
  return (
    <div
      className={`relative min-h-[90vh] w-full bg-no-repeat bg-cover bg-center flex items-center justify-center`}
      style={{
        backgroundImage:
    ...
    >
      <div
        className={`${styles.section} w-[90%] md:w-[60%] bg-white/70 p-6 rounded-xl backdrop-blur-sm`}
      >
